...
var shiba = document.querySelector(".shiba");
var pitbull = document.querySelector(".pitbull");
var shiba_url = "https://dog.ceo/api/breed/shiba/images/random";
var pitbull_url = "https://dog.ceo/api/breed/pitbull/images/random";
var pic_length = 300;

function addNewShiba() {
  if (shiba.hasChildNodes()) {
    shiba.removeChild(shiba.childNodes.item(0)); // because removing the first element moves the second element to the first index
  ...
  var promise = fetch(shiba_url);
  promise.then(function (response) {
    var processingPromise = response.json();
    return processingPromise;
  }).then(function (processedResponse) {
    var shiba_pic = createImgTag(processedResponse.message);
    var shiba_msg = createShibaMsg();
...
function addNewPitbull() {
  if (pitbull.hasChildNodes()) {
    pitbull.removeChild(pitbull.childNodes.item(0)); // because removing the first element moves the second element to the first index
  ...
  var promise = fetch(pitbull_url);
  promise.then(function (response) {
    var processingPromise = response.json();
    return processingPromise;
  }).then(function (processedResponse) {
    var pitbull_pic = createImgTag(processedResponse.message);
    var pitbull_msg = createPitbullLMsg();
...
document.querySelector(".request-complement").addEventListener("click", addNewShiba);
document.querySelector(".request-insult").addEventListener("click", addNewPitbull);
var complementBall = document.querySelector(".request-complement");
var insultBall = document.querySelector(".request-insult");
